...
> This template is distributed with a modified code, which has more `public` fields and methods and polymod's scripted class functionality located in the code itself.
