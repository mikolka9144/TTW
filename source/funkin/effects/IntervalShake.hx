...
{
  public static var _pool:FlxPool<IntervalShake> = new FlxPool<IntervalShake>(IntervalShake.new);

  /**
   * Internal map for looking up which objects are currently shaking and getting their shake data.
   */
  public static var _boundObjects:Map<FlxObject, IntervalShake> = new Map<FlxObject, IntervalShake>();
   ...
   */
  public function shakeProgress(timer:FlxTimer):Void
  {
