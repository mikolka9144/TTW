...
class ModuleHandler
{
  public static var moduleCache:Map<String, Module> = new Map<String, Module>();
  ...
  public static function onStateSwitchComplete():Void
  {
    callEvent(new StateChangeScriptEvent(STATE_CHANGE_END, FlxG.state, true));
  }

  public static function addToModuleCache(module:Module):Void
  {
    moduleCache.set(module.moduleId, module);
  }

  public static function reorderModuleCache():Void
  {
