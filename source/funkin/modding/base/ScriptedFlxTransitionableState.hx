 ...
 */
class ScriptedFlxTransitionableState extends flixel.addons.transition.FlxTransitionableState {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedFlxTransitionableState type
   * @param val2 constructor arguments?
   * @return ScriptedFlxTransitionableState
   */
  public static function init(className:String,val2:String = ''):ScriptedFlxTransitionableState {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic>):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedFlxTransitionableState.
