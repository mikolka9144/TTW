 ...
 */
class ScriptedFlxAtlasSprite extends funkin.graphics.adobeanimate.FlxAtlasSprite {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedFlxAtlasSprite type
   * @param val2 constructor arguments?
   * @return ScriptedFlxAtlasSprite
   */
  public static function init(className:String,val2:String = ''):ScriptedFlxAtlasSprite {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic>):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedFlxAtlasSprite.
