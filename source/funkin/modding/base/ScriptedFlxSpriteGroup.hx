...
class ScriptedFlxSpriteGroup extends flixel.group.FlxSpriteGroup.FlxTypedSpriteGroup<flixel.FlxSprite> {
   ...
   * @param className Name of the target class extending ScriptedFlxSpriteGroup type
   * @param val2 constructor arguments?
   * @return ScriptedFlxSpriteGroup
   */
  public static function init(className:String,val2:String = ''):ScriptedFlxSpriteGroup {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedFlxSpriteGroup.
