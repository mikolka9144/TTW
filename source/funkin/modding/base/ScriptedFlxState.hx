...
class ScriptedFlxState extends flixel.FlxState {
   ...
   * @param className Name of the target class extending ScriptedFlxState type
   * @param val2 constructor arguments?
   * @return ScriptedFlxState
   */
  public static function init(className:String,val2:String = ''):ScriptedFlxState {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic>):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedFlxState.
