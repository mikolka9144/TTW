...
class InitState extends FlxState
{
   ...
   * Setup a bunch of important Flixel stuff.
   */
  public function setupShit():Void
  {
    //
    // GAME SETUP
    //
   ...
   */
  public function startGameNormally():Void
  {
   ...
   * @param difficultyId
   */
  public function startSong(songId:String, difficultyId:String = 'normal'):Void
  {
   ...
   * @param difficultyId
   */
  public function startLevel(levelId:String, difficultyId:String = 'normal'):Void
  {
  ...
  public function setupFlixelDebug():Void
  {
    //
    // FLIXEL DEBUG SETUP
    //
  ...
  public function defineSong():String
  {
    return MacroUtil.getDefine('SONG');
  }

  public function defineLevel():String
  {
    return MacroUtil.getDefine('LEVEL');
  }

  public function defineDifficulty():String
  {
