...
abstract class BaseRegistry<T:(IRegistryEntry<J> & Constructible<EntryConstructorFunction>), J>
{
  ...
  public function loadEntryFile(id:String):JsonFile
  {
   ...
   * @param id
   */
  public function createEntry(id:String):Null<T>
  {
  ...
  public function printErrors(errors:Array<json2object.Error>, id:String = ''):Void
  {
