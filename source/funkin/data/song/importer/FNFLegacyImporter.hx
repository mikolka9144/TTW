...
class FNFLegacyImporter
{
   ...
   */
  public static function rebuildEventData(songData:FNFLegacyData):Array<SongEventData>
  {
   ...
   */
  public static function rebuildTimeChanges(songData:FNFLegacyData):Array<SongTimeChange>
  {
  ...
  public static var STRUMLINE_SIZE = 4;
