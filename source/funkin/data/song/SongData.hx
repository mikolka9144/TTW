...
class SongEventDataRaw implements ICloneable<SongEventDataRaw>
{
  ...
  @:jignored
  public var _stepTime:Null<Float> = null;
...
class SongNoteDataRaw implements ICloneable<SongNoteDataRaw>
{
  ...
  public function set_kind(value:Null<String>):Null<String>
  {
    if (value == '') value = null;
   ...
   */
  @:jignored
  public var _stepLength:Null<Float> = null;
