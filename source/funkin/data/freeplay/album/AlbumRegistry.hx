...
class AlbumRegistry extends BaseRegistry<Album, AlbumData>
{
   ...
   */
  public static var ALBUM_DATA_VERSION:thx.semver.Version = '1.0.0';

  public static var ALBUM_DATA_VERSION_RULE:thx.semver.VersionRule = '1.0.x';

  public static var instance:AlbumRegistry = new AlbumRegistry();
  ...
  public function createScriptedEntry(clsName:String):Album
  {
