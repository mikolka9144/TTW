...
class FreeplayStyleRegistry extends BaseRegistry<FreeplayStyle, FreeplayStyleData>
{
   ...
   */
  public static var FREEPLAYSTYLE_DATA_VERSION:thx.semver.Version = '1.0.0';

  public static var FREEPLAYSTYLE_DATA_VERSION_RULE:thx.semver.VersionRule = '1.0.x';
  ...
  public function createScriptedEntry(clsName:String):FreeplayStyle
  {
