...
class PlayerRegistry extends BaseRegistry<PlayableCharacter, PlayerData>
{
   ...
   */
  public static var PLAYER_DATA_VERSION:thx.semver.Version = "1.0.0";

  public static var PLAYER_DATA_VERSION_RULE:thx.semver.VersionRule = "1.0.x";

  public static var instance(get, never):PlayerRegistry;
  public static var _instance:Null<PlayerRegistry> = null;

  public static function get_instance():PlayerRegistry
  {
   ...
   */
  public var ownedCharacterIds:Map<String, String> = [];
  ...
  public function createScriptedEntry(clsName:String):PlayableCharacter
  {
