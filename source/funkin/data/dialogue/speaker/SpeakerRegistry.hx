...
class SpeakerRegistry extends BaseRegistry<Speaker, SpeakerData>
{
   ...
   */
  public static var SPEAKER_DATA_VERSION:thx.semver.Version = "1.0.0";

  public static var SPEAKER_DATA_VERSION_RULE:thx.semver.VersionRule = "1.0.x";

  public static var instance(get, never):SpeakerRegistry;
  public static var _instance:Null<SpeakerRegistry> = null;

  public static function get_instance():SpeakerRegistry
  {
  ...
  public function createScriptedEntry(clsName:String):Speaker
  {
