...
class ConversationRegistry extends BaseRegistry<Conversation, ConversationData>
{
   ...
   */
  public static var CONVERSATION_DATA_VERSION:thx.semver.Version = "1.0.0";

  public static var CONVERSATION_DATA_VERSION_RULE:thx.semver.VersionRule = "1.0.x";

  public static var instance(get, never):ConversationRegistry;
  public static var _instance:Null<ConversationRegistry> = null;

  public static function get_instance():ConversationRegistry
  {
  ...
  public function createScriptedEntry(clsName:String):Conversation
  {
