...
class StageRegistry extends BaseRegistry<Stage, StageData>
{
   ...
   */
  public static var STAGE_DATA_VERSION:thx.semver.Version = "1.0.2";

  public static var STAGE_DATA_VERSION_RULE:thx.semver.VersionRule = ">=1.0.0 <=1.0.2";

  public static var instance(get, never):StageRegistry;
  public static var _instance:Null<StageRegistry> = null;

  public static function get_instance():StageRegistry
  {
  ...
  public function createScriptedEntry(clsName:String):Stage
  {
