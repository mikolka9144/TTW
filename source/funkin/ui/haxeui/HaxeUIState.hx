...
class HaxeUIState extends MusicBeatState
{
  ...
  public var _componentKey:String;
   ...
   */
  public function showContextMenu(assetPath:String, xPos:Float, yPos:Float):Component
  {
   ...
   */
  public function addUIClickListener(key:String, callback:MouseEvent->Void):Void
  {
   ...
   */
  public function addUIRightClickListener(key:String, callback:MouseEvent->Void):Void
  {
    var target:Component = findComponent(key);
    if (target == null)
    {
  ...
  public function setComponentText(key:String, text:String):Void
  {
    var target:Component = findComponent(key);
    if (target == null)
    {
  ...
  public function setComponentShortcutText(key:String, text:String):Void
  {
  ...
  public function addTooltip(key:String, text:String):Void
  {
    var target:Component = findComponent(key);
    if (target == null)
    {
   ...
   */
  public function addUIChangeListener(key:String, callback:UIEvent->Void):Void
  {
    var target:Component = findComponent(key);
    if (target == null)
    {
   ...
   */
  public function setUIValue<T>(key:String, value:T):T
  {
    var target:Component = findComponent(key);
    if (target == null)
    {
