...
typedef AnimationInfo =
{
  ...
  public var frameRate:Null<Int>; // default 30
  public var looped:Null<Bool>; // default true
  public var flipX:Null<Bool>; // default false
  public var flipY:Null<Bool>; // default false
}
...
class CharacterPlayer extends Box
{
  ...
  public function get_charId():String
  {
    return character?.characterId ?? '';
  }

  public function set_charId(value:String):String
  {
    loadCharacter(value);
    return value;
  }
  ...
  public function get_charName():String
  {
  ...
  public var _redispatchLoaded:Bool = false;
  // possible haxeui bug: if listener is added after event is dispatched, event is "lost"... is it smart to "collect and redispatch"? Not sure
  public var _redispatchStart:Bool = false;
  public var _characterLoaded:Bool = false;
  ...
  public function set_flip(value:Bool):Bool
  {
  ...
  public function set_targetScale(value:Float):Float
  {
  ...
  public function onFrame(name:String, frameNumber:Int, frameIndex:Int):Void
  {
    dispatch(new AnimationEvent(AnimationEvent.FRAME));
  }

  public function onFinish(name:String):Void
  {
    dispatch(new AnimationEvent(AnimationEvent.END));
  }
