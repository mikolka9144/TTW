...
class FunkinPreloader extends FlxBasePreloader
{
   ...
   */
  public static var BASE_WIDTH:Float = 1280;

  /**
   * Margin at the sides and bottom, around the loading bar.
   */
  public static var BAR_PADDING:Float = 20;

  public static var BAR_HEIGHT:Int = 12;

  /**
   * Logo takes this long (in seconds) to fade in.
   */
  public static var LOGO_FADE_TIME:Float = 2.5;

  // Ratio between window size and BASE_WIDTH
  public var ratio:Float = 0;

  public var currentState:FunkinPreloaderState = FunkinPreloaderState.NotStarted;
  ...
  #if TOUCH_HERE_TO_PLAY
  public var touchHereToPlay:Bitmap;
  public var touchHereSprite:Sprite;
  #end
  public var progressBarPieces:Array<Sprite>;
  public var progressBar:Bitmap;
  public var progressLeftText:TextField;
  public var progressRightText:TextField;

  public var dspText:TextField;
  public var fnfText:TextField;
  public var enhancedText:TextField;
  public var stereoText:TextField;

  public var vfdShader:VFDOverlay;
  public var vfdBitmap:Bitmap;
  public var box:Sprite;
  public var progressLines:Sprite;
  ...
  public var lastElapsed:Float = 0.0;
  ...
  public function updateState(percent:Float, elapsed:Float):Float
  {
    switch (currentState)
    {
  ...
  #if TOUCH_HERE_TO_PLAY
  public function overTouchHereToPlay(e:MouseEvent):Void
  {
  ...
  public function outTouchHereToPlay(e:MouseEvent):Void
  {
  ...
  public function mouseDownTouchHereToPlay(e:MouseEvent):Void
  {
    touchHereToPlay.y += 10;
  }

  public function onTouchHereToPlay(e:MouseEvent):Void
  {
    touchHereToPlay.x = (this._width - touchHereToPlay.width) / 2;
    touchHereToPlay.y = (this._height - touchHereToPlay.height) / 2;
  ...
  public static var TOTAL_STEPS:Int = 11;
  public static var ELLIPSIS_TIME:Float = 0.5;
  ...
  public function updateProgressLeftText(text:Null<String>):Void
  {
  ...
  public function immediatelyStartGame():Void
  {
    _loaded = true;
  }
   ...
   */
  public function renderLogoFadeOut(elapsed:Float):Float
  {
  ...
  public function renderLogoFadeIn(elapsed:Float):Void
  {
