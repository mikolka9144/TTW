...
class LoadingState extends MusicBeatSubState
{
  ...
  public var asSubState:Bool = false;

  public var target:NextState;
  public var playParams:Null<PlayStateParams>;
  ...
  public function checkLoadSong(path:String):Void
  {
  ...
  public function checkLibrary(library:String):Void
  {
  ...
  public static function getSongPath():String
  {
    return Paths.inst(PlayState.instance.currentSong.id);
  }

  public static var stageDirectory:String = "shared";
  ...
  #else
  public static function preloadLevelAssets():Void
  {
...
class MultiCallback
{
  ...
  public var unfired = new Map<String, Void->Void>();
  public var fired = new Array<String>();
