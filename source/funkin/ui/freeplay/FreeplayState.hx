...
class FreeplayState extends MusicBeatSubState
{
  ...
  public var diffIdsCurrent:Array<String> = [];
  public var diffIdsTotal:Array<String> = [];
  ...
  public var curCapsule:SongMenuItem;
  public var curPlaying:Bool = false;

  public var dj:DJBoyfriend;
  ...
  public var currentFilter:SongFilter = null;
  public var currentFilteredSongs:Array<FreeplaySongData> = [];
  ...
  public function rankAnimStart(fromResults:Null<FromResultsParams>):Void
  {
    busy = true;
  ...
  public function rankAnimSlam(fromResultsParams:Null<FromResultsParams>)
  {
  ...
  public var veloctiyLoopShit:Float = 0;
  ...
  public function clearDaCache(actualSongTho:String):Void
  {
    for (song in songs)
    {
  ...
  public function capsuleOnConfirmDefault(cap:SongMenuItem):Void
  {
    busy = true;
    letterSort.inputEnabled = false;
...
class FreeplaySongData
{
  ...
  public var displayedVariations:Array<String> = [Constants.DEFAULT_VARIATION];

  public function set_currentDifficulty(value:String):String
  {
