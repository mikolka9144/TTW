...
class FreeplayState extends MusicBeatSubState
{
   ...
   *
   */
  public static var FADE_OUT_DURATION:Float = 0.25;

  /**
   * For the audio preview, the volume at which the fade-in starts.
   */
  public static var FADE_IN_START_VOLUME:Float = 0.25;

  /**
   * For the audio preview, the volume at which the fade-in ends.
   */
  public static var FADE_IN_END_VOLUME:Float = 1.0;

  /**
   * For the audio preview, the volume at which the fade-out starts.
   */
  public static var FADE_OUT_END_VOLUME:Float = 0.0;
  ...
  public var txtCompletion:AtlasText;
  public var lerpCompletion:Float = 0;
  public var intendedCompletion:Float = 0;
  public var lerpScore:Float = 0;
  public var intendedScore:Int = 0;

  public var grpDifficulties:FlxTypedSpriteGroup<DifficultySprite>;

  public var coolColors:Array<Int> = [
    0xFF9271FD,
    0xFF9271FD,
    0xFF223344,
    0xFF941653,
  ...
  public var letterSort:LetterSort;
  public var exitMovers:ExitMoverData = new Map();

  public var exitMoversCharSel:ExitMoverData = new Map();

  public var stickerSubState:Null<StickerSubState> = null;
  ...
  public var rankCamera:FunkinCamera;
  public var rankBg:FunkinSprite;
  public var rankVignette:FlxSprite;

  public var backingCard:Null<BackingCard> = null;
  ...
  public var fadeShader:BlueFade = new BlueFade();

  public var fromResultsParams:Null<FromResultsParams> = null;
  public var prepForNewRank:Bool = false;
  public var styleData:Null<FreeplayStyle> = null;
  public var fromCharSelect:Bool = false;
  ...
  public var currentFilter:Null<SongFilter> = null;
  public var currentFilteredSongs:Array<Null<FreeplaySongData>> = [];
  ...
  public var sparksADD:FlxSprite;

  public function rankAnimStart(fromResults:FromResultsParams):Void
  {
    busy = true;
  ...
  public function rankDisplayNew(fromResults:Null<FromResultsParams>):Void
  {
  ...
  public function rankAnimSlam(fromResultsParams:Null<FromResultsParams>):Void
  {
  ...
  public function tryOpenCharSelect():Void
  {
  ...
  public function transitionToCharSelect():Void
  {
  ...
  public function enterFromCharSel():Void
  {
    busy = true;
    if (_parentState != null) _parentState.persistentDraw = false;
  ...
  public var dxTouch:Float = 0;
  public var dyTouch:Float = 0;
  public var velTouch:Float = 0;

  public var touchTimer:Float = 0;

  public var initTouchPos:FlxPoint = new FlxPoint();

  public var spamTimer:Float = 0;
  ...
  public var originalPos:FlxPoint = new FlxPoint();

  public var hintTimer:Float = 0;
  ...
  public function handleInputs(elapsed:Float):Void
  {
    if (busy) return;
   ...
   * @param force
   */
  public function changeDiff(change:Int = 0, force:Bool = false):Void
  {
    touchTimer = 0;
  ...
  public function capsuleOnConfirmRandom(randomCapsule:SongMenuItem):Void
  {
   ...
   */
  public function capsuleOnOpenDefault(cap:SongMenuItem):Void
  {
  ...
  public function openInstrumentalList(cap:SongMenuItem, instrumentalIds:Array<String>):Void
  {
    busy = true;
  ...
  public var capsuleOptionsMenu:Null<CapsuleOptionsMenu> = null;
   ...
   */
  public function capsuleOnConfirmDefault(cap:SongMenuItem, ?targetInstId:String):Void
  {
    busy = true;
    letterSort.inputEnabled = false;
  ...
  public function refreshCapsuleDisplays():Void
  {
  ...
  public function rememberSelection():Void
  {
...
class DifficultySelector extends FlxSprite
{
  ...
  public var whiteShader:PureColor;
  ...
  public function moveShitDown():Void
  {
    offset.y -= 5;
...
class FreeplaySongData
{
  ...
  public function get_levelId():Null<String>
  {
    return _levelId;
  }

  public var _levelId:String;
  ...
  public function updateValues(variations:Array<String>):Void
  {
  ...
  public function get_songStartingBpm():Float
  {
    var variations:Array<String> = data.getVariationsByCharacterId(FreeplayState.rememberedCharacterId);
