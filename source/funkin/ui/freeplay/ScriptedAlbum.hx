 ...
 */
class ScriptedAlbum extends funkin.ui.freeplay.Album {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedAlbum type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedAlbum
   */
  public static function init(className:String,...args:Any):ScriptedAlbum {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedAlbum.
