...
class SongMenuItem extends FlxSpriteGroup
{
  ...
  public var pixelIcon:FlxSprite;
  ...
  public var ranks:Array<String> = ["fail", "average", "great", "excellent", "perfect", "perfectsick"];
  ...
  public var impactThing:FunkinSprite;

  public var sparkle:FlxSprite;

  public var sparkleTimer:FlxTimer;
  ...
  public function sparkleEffect(timer:FlxTimer):Void
  {
  ...
  public function checkWeek(name:String):Void
  {
    // trace(name);
    var weekNum:Int = 0;
    switch (name)
  ...
  public function set_hsvShader(value:HSVShader):HSVShader
  {
  ...
  public function textAppear():Void
  {
  ...
  public var frameInTicker:Float = 0;
  public var frameInTypeBeat:Int = 0;

  public var frameOutTicker:Float = 0;
  public var frameOutTypeBeat:Int = 0;

  public var xFrames:Array<Float> = [1.7, 1.8, 0.85, 0.85, 0.97, 0.97, 1];
  public var xPosLerpLol:Array<Float> = [0.9, 0.4, 0.16, 0.16, 0.22, 0.22, 0.245]; // NUMBERS ARE JANK CUZ THE SCALING OR WHATEVER
  public var xPosOutLerpLol:Array<Float> = [0.245, 0.75, 0.98, 0.98, 1.2]; // NUMBERS ARE JANK CUZ THE SCALING OR WHATEVER
...
class FreeplayRank extends FlxSprite
{
  ...
  public function set_rank(val:Null<ScoringRank>):Null<ScoringRank>
  {
    rank = val;
...
class CapsuleNumber extends FlxSprite
{
  ...
  public var numToString:Array<String> = ["ZERO", "ONE", "TWO", "THREE", "FOUR", "FIVE", "SIX", "SEVEN", "EIGHT", "NINE"];
