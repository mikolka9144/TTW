...
{
  public var capsuleMenuBG:FunkinSprite;
  public var parent:FreeplayState;

  public var queueDestroy:Bool = false;

  public var instrumentalIds:Array<String> = [''];
  public var currentInstrumentalIndex:Int = 0;

  public var currentInstrumental:FlxText;
...
class InstrumentalSelector extends FunkinSprite
{
  ...
  public var baseScale:Float = 0.6;
