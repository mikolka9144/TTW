...
class AlbumRoll extends FlxSpriteGroup
{
  ...
  public function set_albumId(value:Null<String>):Null<String>
  {
  ...
  public var newAlbumArt:FlxAtlasSprite;
  public var albumTitle:FunkinSprite;

  public var difficultyStars:DifficultyStars;
  public var _exitMovers:Null<FreeplayState.ExitMoverData>;
  public var _exitMoversCharSel:Null<FreeplayState.ExitMoverData>;

  public var albumData:Album;
  ...
  public function onAlbumFinish(animName:String):Void
  {
  ...
  public var titleTimer:Null<FlxTimer> = null;
