...
class DJBoyfriend extends FlxAtlasSprite
{
  ...
  public var gotSpooked:Bool = false;

  public static var SPOOK_PERIOD:Float = 60.0;
  public static var TV_PERIOD:Float = 120.0;

  // Time since dad last SPOOKED you.
  public var timeSinceSpook:Float = 0;
  ...
  public var lowPumpLoopPoint:Int = 4;
  ...
  public var cartoonSnd:Null<FunkinSound> = null;
  ...
  public function getRandomFlashToon():String
  {
