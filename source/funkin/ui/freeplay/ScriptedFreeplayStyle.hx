 ...
 */
class ScriptedFreeplayStyle extends funkin.ui.freeplay.FreeplayStyle {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedFreeplayStyle type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedFreeplayStyle
   */
  public static function init(className:String,...args:Any):ScriptedFreeplayStyle {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedFreeplayStyle.
