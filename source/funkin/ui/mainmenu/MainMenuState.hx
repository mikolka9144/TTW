...
{
  public var menuItems:MenuTypedList<AtlasMenuItem>;
  ...
  public function resetCamStuff(?snap:Bool = true):Void
  {
  ...
  public function createMenuItem(name:String, atlas:String, callback:Void->Void, fireInstantly:Bool = false):Void
  {
  ...
  public function startExitState(state:NextState):Void
  {
