...
class ControlsMenu extends funkin.ui.options.OptionsState.Page
{
  ...
  public static var controlList = Control.createAll();
  /*
  ...
  public var itemGroups:Array<Array<InputItem>> = [for (i in 0...controlGroups.length) []];

  public var controlGrid:MenuTypedList<InputItem>;
  public var deviceList:TextMenuList;
  public var menuCamera:FlxCamera;
  public var prompt:Prompt;
  public var camFollow:FlxObject;
  public var labels:FlxTypedGroup<AtlasText>;

  public var currentDevice:Device = Keys;
  ...
  public var keyUsedToEnterPrompt:Null<Int> = null;
  public var buttonUsedToEnterPrompt:Null<Int> = null;
  ...
  public function onInputSelect(input:Int):Void
  {
