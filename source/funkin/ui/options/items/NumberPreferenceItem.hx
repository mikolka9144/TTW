...
class NumberPreferenceItem extends TextMenuItem
{
  ...
  // Constants
  public static var HOLD_DELAY:Float = 0.3; // seconds
  public static var CHANGE_RATE:Float = 0.08; // seconds
  ...
  // Variables
  public var holdDelayTimer:Float = HOLD_DELAY; // seconds
  public var changeRateTimer:Float = 0.0; // seconds
  ...
  public function formatted(value:Float):String
  {
  ...
  public function toFixed(value:Float):Float
  {
