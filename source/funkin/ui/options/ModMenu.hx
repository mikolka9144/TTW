...
{
  public var grpMods:FlxTypedGroup<ModMenuItem>;
  public var enabledMods:Array<ModMetadata> = [];
  public var detectedMods:Array<ModMetadata> = [];
  ...
  public function selections(change:Int = 0):Void
  {
    curSelected += change;
  ...
  public function organizeByY():Void
  {
