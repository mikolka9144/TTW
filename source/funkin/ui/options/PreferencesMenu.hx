...
class PreferencesMenu extends Page
{
  ...
  public var preferenceItems:FlxTypedSpriteGroup<FlxSprite>;
   ...
   */
  public function createPrefItems():Void
  {
   ...
   */
  public function createPrefItemCheckbox(prefName:String, prefDesc:String, onChange:Bool->Void, defaultValue:Bool):Void
  {
   ...
   * @param defaultValue The value that is loaded in when the pref item is created (usually your Preferences.settingVariable)
   */
  public function createPrefItemEnum(prefName:String, prefDesc:String, values:Map<String, String>, onChange:String->Void, defaultValue:String):Void
  {
