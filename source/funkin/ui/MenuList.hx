...
class MenuTypedList<T:MenuListItem> extends FlxTypedGroup<T>
{
  ...
  public function navAxis(index:Int, size:Int, prev:Bool, next:Bool, allowWrap:Bool):Int
  {
   ...
   */
  public function navGrid(latSize:Int, latPrev:Bool, latNext:Bool, latAllowWrap:Bool, prev:Bool, next:Bool, allowWrap:Bool):Int
  {
