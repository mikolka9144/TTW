...
{
  public static var DEFAULT_BACKGROUND_COLOR:FlxColor = FlxColor.fromString('#F9CF51');
  public static var BACKGROUND_HEIGHT:Int = 400;

  public var currentDifficultyId:String = 'normal';

  public var currentLevelId:String = 'tutorial';
  public var currentLevel:Level;
  public var isLevelUnlocked:Bool;
  public var currentLevelTitle:LevelTitle;

  public var highScore:Int = 42069420;
  public var highScoreLerp:Int = 12345678;

  public var exitingMenu:Bool = false;
  public var selectedLevel:Bool = false;
   ...
   */
  public var levelTitleText:FlxText;
   ...
   */
  public var tracklistText:FlxText;

  /**
   * The titles of the levels in the middle.
   */
  public var levelTitles:FlxTypedGroup<LevelTitle>;

  /**
   * The props in the center.
   */
  public var levelProps:FlxTypedGroup<LevelProp>;

  /**
   * The background behind the props.
   */
  public var levelBackground:FlxSprite;

  /**
   * The left arrow of the difficulty selector.
   */
  public var leftDifficultyArrow:FlxSprite;

  /**
   * The right arrow of the difficulty selector.
   */
  public var rightDifficultyArrow:FlxSprite;
  ...
  public static var rememberedLevelId:Null<String> = null;
  ...
  public function buildDifficultySprite(?diff:String):Void
  {
  ...
  public function buildLevelTitles():Void
  {
    levelTitles.clear();
   ...
   */
  public function changeLevel(change:Int = 0):Void
  {
  ...
  public function funnyMusicThing():Void
  {
  ...
  public function updateBackground(?previousLevelId:String = ''):Void
  {
