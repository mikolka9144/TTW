 ...
 */
class ScriptedLevel extends funkin.ui.story.Level {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedLevel type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedLevel
   */
  public static function init(className:String,...args:Any):ScriptedLevel {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedLevel.
