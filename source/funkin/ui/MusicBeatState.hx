...
class MusicBeatState extends FlxTransitionableState implements IEventHandler
{
  ...
  public function handleFunctionControls():Void
  {
  ...
  public function onOpenSubStateComplete(targetState:FlxSubState):Void
  {
  ...
  public function onCloseSubStateComplete(targetState:FlxSubState):Void
  {
