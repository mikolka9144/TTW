...
class TitleState extends MusicBeatState
{
  ...
  public var swagShader:ColorSwap;
  ...
  public function overlay_onMouseDown(event:MouseEvent):Void
  {
   ...
   */
  public function moveToAttract():Void
  {
  ...
  public function cheatCodeShit():Void
  {
  ...
  public function startCheat():Void
  {
    cheatActive = true;
