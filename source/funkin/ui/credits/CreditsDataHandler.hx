...
class CreditsDataHandler
{
  ...
  public static function get_CREDITS_DATA():Null<CreditsData>
  {
  ...
  public static function fetchCreditsData():funkin.data.JsonFile
  {
    #if !macro
  ...
  public static function parseCreditsData(file:JsonFile):Null<CreditsData>
  {
    #if !macro
  ...
  public static function printErrors(errors:Array<json2object.Error>, id:String = ''):Void
  {
