 ...
 */
class ScriptedNoteStyle extends funkin.play.notes.notestyle.NoteStyle {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedNoteStyle type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedNoteStyle
   */
  public static function init(className:String,...args:Any):ScriptedNoteStyle {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedNoteStyle.
