...
class NoteStyle implements IRegistryEntry<NoteStyleData>
{
   ...
   */
  public var fallback(get, never):Null<NoteStyle>;

  public function get_fallback():Null<NoteStyle> {
  ...
  public var noteFrames:Null<FlxAtlasFrames> = null;

  public function buildNoteFrames(force:Bool = false):Null<FlxAtlasFrames>
  {
  ...
  public function fetchNoteAnimationData(dir:NoteDirection):Null<AnimationData>
  {
  ...
  public function buildCountdownSpriteLibrary(step:Countdown.CountdownStep):Null<String>
  {
    var basePath:Null<String> = null;
    switch (step)
    {
  ...
  public static function _fetchData(id:String):NoteStyleData
  {
