...
{
  public static var DIRECTION_COLORS:Array<String> = ['purple', 'blue', 'green', 'red'];
  ...
  public function get_strumTime():Float
  {
    return this.noteData?.time ?? 0.0;
  }

  public function set_strumTime(value:Float):Float
  {
  ...
  public function get_kind():Null<String>
  {
  ...
  public function get_params():Array<NoteParamData>
  {
    return this.noteData?.params ?? [];
  }

  public function set_params(value:Array<NoteParamData>):Array<NoteParamData>
  {
    if (this.noteData == null) return value;
  ...
  public function playNoteAnimation(value:Int):Void
  {
