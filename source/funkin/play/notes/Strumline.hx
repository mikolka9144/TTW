...
class Strumline extends FlxSpriteGroup
{
  ...
  public static var STRUMLINE_SIZE:Int = 104;
  public static var NOTE_SPACING:Int = STRUMLINE_SIZE + 8;

  // Positional fixes for new strumline graphics.
  public static var INITIAL_OFFSET = -0.275 * STRUMLINE_SIZE;
  public static var NUDGE:Float = 2.0;

  public static var KEY_COUNT:Int = 4;
  public static var NOTE_SPLASH_CAP:Int = 6;

  public static var RENDER_DISTANCE_MS(get, never):Float;

  public static function get_RENDER_DISTANCE_MS():Float
  {
  ...
  public var _conductorInUse:Null<Conductor>;

  public function get_conductorInUse():Conductor
  {
    if (_conductorInUse == null) return Conductor.instance;
    return _conductorInUse;
  }

  public function set_conductorInUse(value:Conductor):Conductor
  {
  ...
  public var ghostTapTimer:Float = 0.0;
  #end
  ...
  #if FEATURE_GHOST_TAPPING
  public function updateGhostTapTimer(elapsed:Float):Void
  {
   ...
   */
  public function constructNoteSplash():NoteSplash
  {
   ...
   * Custom recycling behavior.
   */
  public function constructNoteHoldCover():NoteHoldCover
  {
   ...
   * Custom recycling behavior.
   */
  public function constructNoteSprite():NoteSprite
  {
   ...
   * Custom recycling behavior.
   */
  public function constructHoldNoteSprite():SustainTrail
  {
   ...
   */
  public function fadeInArrow(index:Int, arrow:StrumlineNote):Void
  {
    arrow.y -= 10;
    arrow.alpha = 0.0;
  ...
  public function compareNoteData(order:Int, a:SongNoteData, b:SongNoteData):Int
  {
    return FlxSort.byValues(order, a.time, b.time);
  }

  public function compareNoteSprites(order:Int, a:NoteSprite, b:NoteSprite):Int
  {
    return FlxSort.byValues(order, a?.strumTime, b?.strumTime);
  }

  public function compareHoldNoteSprites(order:Int, a:SustainTrail, b:SustainTrail):Int
  {
    return FlxSort.byValues(order, a?.strumTime, b?.strumTime);
  }
}
