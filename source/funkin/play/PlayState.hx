...
class PlayState extends MusicBeatSubState
{
  ...
  public function get_stageZoom():Float
  {
  ...
  public function get_isSubState():Bool
  {
  ...
  public function get_isChartingMode():Bool
  {
  ...
  **/
  public var inputPressQueue:Array<PreciseInputEvent> = [];

  /**
   * Key release inputs which have been received but not yet processed.
   * These are encoded with an OS timestamp, so they
  **/
  public var inputReleaseQueue:Array<PreciseInputEvent> = [];
   ...
   */
  public var songEvents:Array<SongEventData>;
   ...
   */
  public var skipHeldTimer:Float = 0;
   ...
   */
  public var criticalFailure:Bool = false;
   ...
   */
  public var musicPausedBySubState:Bool = false;

  /**
   * Track any camera tweens we've paused for a Pause substate, so we can unpause them when we return.
   */
  public var cameraTweensPausedBySubState:List<FlxTween> = new List<FlxTween>();
  ...
  public function get_isGamePaused():Bool
  {
  ...
  public var isExitingViaPauseMenu(get, never):Bool;

  public function get_isExitingViaPauseMenu():Bool
  {
  ...
  public function get_currentChart():SongDifficulty
  {
  ...
  public function get_currentStageId():String
  {
  ...
  public function get_currentSongLengthMs():Float
  {
  ...
  public static var BACKGROUND_COLOR:FlxColor = FlxColor.BLACK;
  ...
  public function assertChartExists():Bool
  {
  ...
  public function moveToGameOver():Void
  {
  ...
  public function processSongEvents():Void
  {
  ...
  /**
     ...
     * @param id
     */
  public function loadStage(id:String):Void
  {
  ...
  /**
     ...
     */
  public function initStrumlines():Void
  {
  ...
  public function buildDiscordRPCDetails():String
  {
  ...
  public function initPreciseInputs():Void
  {
  ...
  public function onStrumlineNoteIncoming(noteSprite:NoteSprite):Void
  {
  ...
  /**
     ...
     */
  public function onConversationComplete():Void
  {
    isInCutscene = false;
  ...
  /**
     ...
     */
  public function onKeyPress(event:PreciseInputEvent):Void
  {
  ...
  /**
     ...
     */
  public function onKeyRelease(event:PreciseInputEvent):Void
  {
    if (isGamePaused) return;
  ...
  /**
     ...
     */
  public var inputSpitter:Array<ScoreInput> = [];
  ...
  /**
     ...
     */
  public function processInputQueue():Void
  {
  ...
  public function goodNoteHit(note:NoteSprite, input:PreciseInputEvent):Void
  {
  ...
  /**
     ...
     * @param note
     */
  public function onNoteMiss(note:NoteSprite, playSound:Bool = false, healthChange:Float):Void
  {
  ...
  /**
     ...
     */
  public function ghostNoteMiss(direction:NoteDirection, hasPossibleNotes:Bool = true):Void
  {
  ...
  /**
     ...
     */
  public function popUpScore(daRating:String, ?combo:Int):Void
  {
    if (daRating == 'miss')
    {
  ...
  /**
     ...
     */
  public function handleCutsceneKeys(elapsed:Float):Void
  {
    if (isGamePaused) return;
  ...
  /**
     ...
     */
  public function skipVideoCutscene():Void
  {
  ...
  /**
     ...
     */
  public function zoomIntoResultsScreen(isNewHighscore:Bool, ?prevScoreData:SaveScoreData):Void
  {
  ...
  /**
     ...
     */
  public function moveToResultsScreen(isNewHighscore:Bool, ?prevScoreData:SaveScoreData):Void
  {
    persistentUpdate = false;
    vocals.stop();
    camHUD.alpha = 1;
  ...
  public var prevScrollTargets:Array<Dynamic> = []; // used to snap scroll speed when things go unruely
