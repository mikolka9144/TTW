...
class GameOverSubState extends MusicBeatSubState
{
  ...
  public static var blueballed:Bool = false;

  /**
   * The boyfriend character.
   */
  public var boyfriend:Null<BaseCharacter> = null;
   ...
   */
  public var gameOverMusic:Null<FunkinSound> = null;
  ...
  public static var CAMERA_ZOOM_DURATION:Float = 0.5;
  ...
  @:nullSafety(Off)
  public function setCameraTarget():Void
  {
   ...
   * @return FlxPoint
   */
  public function getMidPointOld(spr:FlxSprite, ?point:FlxPoint):FlxPoint
  {
  ...
  public var hasStartedAnimation:Bool = false;
   ...
   */
  public function confirmDeath():Void
  {
    if (!isEnding)
    {
      isEnding = true;
   ...
   */
  public function resolveMusicPath(suffix:String, starting:Bool = false, ending:Bool = false):Null<String>
  {
...
{
  public var isChartingMode:Bool;
  public var transparent:Bool;
}
