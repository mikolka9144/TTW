...
class BaseCharacter extends Bopper
{
  ...
  public function get_characterOrigin():FlxPoint
  {
  ...
  public function get_cornerPosition():FlxPoint
  {
    return new FlxPoint(x, y);
  }

  public function set_cornerPosition(value:FlxPoint):FlxPoint
  {
  ...
  public function get_feetPosition():FlxPoint
  {
  ...
  public function findCountAnimations(prefix:String):Array<Int>
  {
   ...
   */
  public var characterCameraOffsets(get, never):Array<Float>;

  public function get_characterCameraOffsets():Array<Float>
  {
   ...
   */
  public function justPressedNote(player:Int = 1):Bool
  {
   ...
   * On non-player characters, this should be ignored.
   */
  public function isHoldingNote(player:Int = 1):Bool
  {
    // Returns true if at least one of LEFT, DOWN, UP, or RIGHT is being held.
    switch (player)
    {
  ...
  public function playComboAnimation(comboCount:Int):Void
  {
  ...
  public function playComboDropAnimation(comboCount:Int):Void
  {
