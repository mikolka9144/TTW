...
class AnimateAtlasCharacter extends BaseCharacter
{
  ...
  public var _skipTransformChildren:Bool = false;

  public var animations:Map<String, AnimateAtlasAnimation> = new Map<String, AnimateAtlasAnimation>();
  public var currentAnimName:Null<String> = null;
  ...
  public function loadAtlasSprite():FlxAtlasSprite
  {
  ...
  public function setSprite(sprite:FlxAtlasSprite):Void
  {
  ...
  public function getAnimationData(name:String = null):AnimateAtlasAnimation
  {
  ...
  public function findMinXHelper():Float
  {
  ...
  public function findMaxXHelper():Float
  {
  ...
  public function findMinYHelper():Float
  {
  ...
  public function findMaxYHelper():Float
  {
