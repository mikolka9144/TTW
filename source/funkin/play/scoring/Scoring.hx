...
class Scoring
{
  ...
  public static function judgeNotePBOT1(msTiming:Float):String
  {
    var absTiming:Float = Math.abs(msTiming);
  ...
  public static function judgeNoteLEGACY(msTiming:Float):String
  {
    var absTiming:Float = Math.abs(msTiming);
  ...
  public static function judgeNoteWEEK7(msTiming:Float):String
  {
