...
class HealthIcon extends FunkinSprite
{
  ...
  public function onSetSize(value:FlxPoint):Void
  {
    snapToTargetSize();
  }

  public function set_characterId(value:Null<String>):String
  {
   ...
   * @param charId
   */
  public function loadAnimationNew():Void
  {
   ...
   * @param charId
   */
  public function loadAnimationOld():Void
  {
  ...
  public function iconExists(charId:String):Bool
  {
    return Assets.exists(Paths.image('icons/icon-$charId'));
  }

  public function isNewSpritesheet(charId:String):Bool
  {
    return Assets.exists(Paths.file('images/icons/icon-$characterId.xml'));
  }

  public function loadCharacter(charId:Null<String>):Void
  {
