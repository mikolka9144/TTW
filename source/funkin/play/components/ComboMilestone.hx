...
class ComboMilestone extends FlxTypedSpriteGroup<FlxSprite>
{
  ...
  public var wasComboSetup:Bool = false;
  public var daCombo:Int = 0;

  public var grpNumbers:FlxTypedGroup<ComboMilestoneNumber>;

  public var onScreenTime:Float = 0;
  ...
  public function setupCombo(daCombo:Int)
  {
...
class ComboMilestoneNumber extends FlxSprite
{
  ...
  public var shiftedX:Bool = false;
