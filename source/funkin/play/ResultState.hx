...
class ResultState extends MusicBeatSubState
{
  ...
  public var playerCharacterId:Null<String>;

  public var introMusicAudio:Null<FunkinSound>;
  ...
  public function getMusicPath(playerCharacter:Null<PlayableCharacter>, rank:ScoringRank):String
  {
