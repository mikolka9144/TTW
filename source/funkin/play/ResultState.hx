...
class ResultState extends MusicBeatSubState
{
  ...
  public var bfPerfect:Null<FlxAtlasSprite> = null;
  public var heartsPerfect:Null<FlxAtlasSprite> = null;
  public var bfExcellent:Null<FlxAtlasSprite> = null;
  public var bfGreat:Null<FlxAtlasSprite> = null;
  public var gfGreat:Null<FlxAtlasSprite> = null;
  public var bfGood:Null<FlxSprite> = null;
  public var gfGood:Null<FlxSprite> = null;
  public var bfShit:Null<FlxAtlasSprite> = null;
  ...
  public var rankTallyTimer:Null<FlxTimer> = null;
  public var clearPercentTarget:Int = 100;
  public var clearPercentLerp:Int = 0;

  public function startRankTallySequence():Void
  {
  ...
  public function displayRankText():Void
  {
    bgFlash.visible = true;
    bgFlash.alpha = 1;
  ...
  public function afterRankTallySequence():Void
  {
  ...
  public function timerThenSongName(timerLength:Float = 3.0, autoScroll:Bool = true):Void
  {
  ...
  public function showSmallClearPercent():Void
  {
    if (clearPercentSmall != null)
    {
  ...
  public var movingSongStuff:Bool = false;
  public var speedOfTween:FlxPoint = FlxPoint.get(-1, 1);
...
typedef ResultsStateParams =
{
   ...
   */
  public var scoreData:SaveScoreData;

  /**
   * The previous score data, used for rank comparision.
   */
  public var ?prevScoreData:SaveScoreData;
};
