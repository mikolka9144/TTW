...
class ResultScore extends FlxTypedSpriteGroup<ScoreNum>
{
  ...
  public function set_scoreShit(val):Int
  {
...
class ScoreNum extends FlxSprite
{
  ...
  public function set_finalDigit(val):Int
  {
  ...
  public var numToString:Array<String> = [
    "ZERO", "ONE", "TWO", "THREE", "FOUR", "FIVE", "SIX", "SEVEN", "EIGHT", "NINE", "DISABLED"
  ];

  public function finishShuffleTween():Void{
  ...
  public function shuffleProgress(shuffleTimer:FlxTimer):Void
  {
