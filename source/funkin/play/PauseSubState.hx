...
class PauseSubState extends MusicBeatSubState
{
   ...
   */
  public static var PAUSE_MENU_ENTRIES_STANDARD:Array<PauseMenuEntry> = [
   ...
   */
  public static var PAUSE_MENU_ENTRIES_CHARTING:Array<PauseMenuEntry> = [
    {text: 'Resume', callback: resume},
    {text: 'Restart Song', callback: restartPlayState},
   ...
   */
  public static var PAUSE_MENU_ENTRIES_DIFFICULTY:Array<PauseMenuEntry> = [
   ...
   */
  public static var PAUSE_MENU_ENTRIES_VIDEO_CUTSCENE:Array<PauseMenuEntry> = [
    {text: 'Resume', callback: resume},
   ...
   */
  public static var PAUSE_MENU_ENTRIES_CONVERSATION:Array<PauseMenuEntry> = [
    {text: 'Resume', callback: resume},
   ...
   */
  public static var MUSIC_FADE_IN_TIME:Float = 5;

  /**
   * The final volume for the music when the pause menu is opened.
   */
  public static var MUSIC_FINAL_VOLUME:Float = 0.75;

  public static var CHARTER_FADE_DELAY:Float = 15.0;

  public static var CHARTER_FADE_DURATION:Float = 0.75;
   ...
   */
  public var currentMenuEntries:Array<PauseMenuEntry>;
   ...
   */
  public var currentMode:PauseMode;
  ...
  // Audio Variables
  // ===============
  public var pauseMusic:FunkinSound;
   ...
   */
  public function startPauseMusic():Void
  {
  ...
  public var charterFadeTween:Null<FlxTween> = null;

  public function startCharterTimer():Void
  {
  ...
  public function startArtistTimer():Void
  {
    charterFadeTween = FlxTween.tween(metadataArtist, {alpha: 0.0}, CHARTER_FADE_DURATION,
      {
        startDelay: CHARTER_FADE_DELAY,
   ...
   */
  public function regenerateMenu(?targetMode:PauseMode):Void
  {
   ...
   */
  public function chooseMenuEntries():Void
  {
   ...
   */
  public function clearAndAddMenuEntries():Void
  {
   ...
   */
  public function updateMetadataText():Void
  {
    metadataPractice.visible = PlayState.instance?.isPracticeMode ?? false;
   ...
   */
  public static function resume(state:PauseSubState):Void
  {
   ...
   */
  public static function switchMode(state:PauseSubState, targetMode:PauseMode):Void
  {
   ...
   */
  public static function changeDifficulty(state:PauseSubState, difficulty:String):Void
  {
   ...
   * @param state The current PauseSubState.
   */
  public static function restartPlayState(state:PauseSubState):Void
  {
    PlayState.instance.needsReset = true;
    state.close();
  }
   ...
   * @param state The current PauseSubState.
   */
  public static function enablePracticeMode(state:PauseSubState):Void
  {
   ...
   * @param state The current PauseSubState.
   */
  public static function restartVideoCutscene(state:PauseSubState):Void
  {
   ...
   * @param state The current PauseSubState.
   */
  public static function skipVideoCutscene(state:PauseSubState):Void
  {
   ...
   * @param state The current PauseSubState.
   */
  public static function restartConversation(state:PauseSubState):Void
  {
   ...
   * @param state The current PauseSubState.
   */
  public static function skipConversation(state:PauseSubState):Void
  {
    if (PlayState.instance?.currentConversation == null) return;
   ...
   * @param state The current PauseSubState.
   */
  public static function quitToMenu(state:PauseSubState):Void
  {
   ...
   * @param state The current PauseSubState.
   */
  public static function quitToChartEditor(state:PauseSubState):Void
  {
    state.close();
