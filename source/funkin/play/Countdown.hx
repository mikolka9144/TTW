...
class Countdown
{
  ...
  public static var noteStyle:NoteStyle;

  public static var fallbackNoteStyle:Null<NoteStyle>;

  /**
   * The currently running countdown. This will be null if there is no countdown running.
   */
  public static var countdownTimer:FlxTimer = null;
   ...
   */
  public static function propagateCountdownEvent(index:CountdownStep):Bool
  {
   ...
   */
  public static function fetchNoteStyle(?noteStyleId:String, force:Bool = false):Void
  {
