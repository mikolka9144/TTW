 ...
 */
class ScriptedDialogueBox extends DialogueBox {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedDialogueBox type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedDialogueBox
   */
  public static function init(className:String,...args:Any):ScriptedDialogueBox {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedDialogueBox.
