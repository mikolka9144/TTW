...
class DialogueBox extends FlxSpriteGroup implements IDialogueScriptedClass implements IRegistryEntry<DialogueBoxData>
{
  ...
  public function get_dialogueBoxName():String
  {
  ...
  public var textDisplay:FlxTypeText;
  ...
  public function loadSpritesheet():Void
  {
  ...
  public static function _fetchData(id:String):Null<DialogueBoxData>
  {
