...
class Conversation extends FlxSpriteGroup implements IDialogueScriptedClass implements IRegistryEntry<ConversationData>
{
   ...
   */
  public var state:ConversationState = ConversationState.Start;
   ...
   */
  public var currentDialogueEntry:Int = 0;

  public var currentDialogueEntryCount(get, never):Int;

  public function get_currentDialogueEntryCount():Int
  {
  ...
  * **/
  ...
  public var currentDialogueLineCount(get, never):Int;

  public function get_currentDialogueLineCount():Int
  {
    return currentDialogueEntryData.text.length;
  }

  public var currentDialogueEntryData(get, never):DialogueEntryData;

  public function get_currentDialogueEntryData():DialogueEntryData
  {
  ...
  public var currentDialogueLineString(get, never):String;

  public function get_currentDialogueLineString():String
  {
   ...
   * GRAPHICS
   */
  public var backdrop:FunkinSprite;

  public var currentSpeaker:Speaker;

  public var currentDialogueBox:DialogueBox;
  ...
  public function setupBackdrop():Void
  {
    if (backdrop != null)
    {
      backdrop.destroy();
  ...
  public function showCurrentSpeaker():Void
  {
  ...
  public function playSpeakerAnimation():Void
  {
  ...
  public function showCurrentDialogueBox():Void
  {
  ...
  public function playDialogueBoxAnimation():Void
  {
  ...
  public var outroTween:FlxTween;
   ...
   * @param event
   */
  public function propagateEvent(event:ScriptEvent):Void
  {
  ...
  public static function _fetchData(id:String):Null<ConversationData>
  {
