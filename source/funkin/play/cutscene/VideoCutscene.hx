...
class VideoCutscene
{
  ...
  #if html5
  public static var vid:FlxVideo;
  #end
  #if hxCodec
  public static var vid:FunkinVideoSprite;
  #end
  ...
  #if html5
  public static function playVideoHTML5(filePath:String):Void
  {
  ...
  #if hxCodec
  public static function playVideoNative(filePath:String):Void
  {
    // Video displays OVER the FlxState.
   ...
   */
  public static function onCutsceneFinish(cutsceneType:CutsceneType):Void
  {
    switch (cutsceneType)
    {
