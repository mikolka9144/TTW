...
class Stage extends FlxSpriteGroup implements IPlayStateScriptedClass implements IRegistryEntry<StageData>
{
  ...
  public function get_camZoom():Float
  {
    return _data?.cameraZoom ?? 1.0;
  }

  public var frameBufferMan:FrameBufferManager;
  ...
  public var namedProps:Map<String, StageProp> = new Map<String, StageProp>();
  public var characters:Map<String, BaseCharacter> = new Map<String, BaseCharacter>();
  public var boppers:Array<Bopper> = new Array<Bopper>();
  ...
  public var debugIconGroup:FlxSpriteGroup;
   ...
   */
  public function setupFrameBuffers():Void {}
   ...
   * frame buffers.
   */
  public function frameBuffersUpdated():Void {}
  ...
  public static function _fetchData(id:String):Null<StageData>
  {
