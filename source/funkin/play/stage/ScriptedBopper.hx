 ...
 */
class ScriptedBopper extends funkin.play.stage.Bopper {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedBopper type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedBopper
   */
  public static function init(className:String,...args:Any):ScriptedBopper {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedBopper.
