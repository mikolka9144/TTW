 ...
 */
class ScriptedSong extends funkin.play.song.Song {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedSong type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedSong
   */
  public static function init(className:String,...args:Any):ScriptedSong {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedSong.
