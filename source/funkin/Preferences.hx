...
class Preferences
{
  ...
  public static function set_framerate(value:Int):Int
  {
    #if web
    return 60;
    #else
  ...
  public static function get_unlockedFramerate():Bool
  {
    return Save?.instance?.options?.unlockedFramerate;
  }

  public static function set_unlockedFramerate(value:Bool):Bool
  {
  ...
  public static function toggleFramerateCap(unlocked:Bool):Void
  {
    #if web
