...
class DiscordClient
{
  public static var CLIENT_ID:String = "816168432860790794";

  public static var instance(get, never):DiscordClient;
  public static var _instance:Null<DiscordClient> = null;

  public static function get_instance():DiscordClient
  {
  ...
  public var handlers:DiscordEventHandlers;
  ...
  public var daemon:Thread = null;

  public function createDaemon():Void
  {
    daemon = Thread.create(doDaemonWork);
  }

  public function doDaemonWork():Void
  {
    while (true)
    {
  ...
  public function buildPresence(params:DiscordClientPresenceParams):DiscordRichPresence
  {
