...
class Controls extends FlxActionSet
{
   ...
   */
  public var _ui_up = new FunkinAction(Action.UI_UP);

  public var _ui_left = new FunkinAction(Action.UI_LEFT);
  public var _ui_right = new FunkinAction(Action.UI_RIGHT);
  public var _ui_down = new FunkinAction(Action.UI_DOWN);
  public var _ui_upP = new FunkinAction(Action.UI_UP_P);
  public var _ui_leftP = new FunkinAction(Action.UI_LEFT_P);
  public var _ui_rightP = new FunkinAction(Action.UI_RIGHT_P);
  public var _ui_downP = new FunkinAction(Action.UI_DOWN_P);
  public var _ui_upR = new FunkinAction(Action.UI_UP_R);
  public var _ui_leftR = new FunkinAction(Action.UI_LEFT_R);
  public var _ui_rightR = new FunkinAction(Action.UI_RIGHT_R);
  public var _ui_downR = new FunkinAction(Action.UI_DOWN_R);
  public var _note_up = new FunkinAction(Action.NOTE_UP);
  public var _note_left = new FunkinAction(Action.NOTE_LEFT);
  public var _note_right = new FunkinAction(Action.NOTE_RIGHT);
  public var _note_down = new FunkinAction(Action.NOTE_DOWN);
  public var _note_upP = new FunkinAction(Action.NOTE_UP_P);
  public var _note_leftP = new FunkinAction(Action.NOTE_LEFT_P);
  public var _note_rightP = new FunkinAction(Action.NOTE_RIGHT_P);
  public var _note_downP = new FunkinAction(Action.NOTE_DOWN_P);
  public var _note_upR = new FunkinAction(Action.NOTE_UP_R);
  public var _note_leftR = new FunkinAction(Action.NOTE_LEFT_R);
  public var _note_rightR = new FunkinAction(Action.NOTE_RIGHT_R);
  public var _note_downR = new FunkinAction(Action.NOTE_DOWN_R);
  public var _accept = new FunkinAction(Action.ACCEPT);
  public var _back = new FunkinAction(Action.BACK);
  public var _pause = new FunkinAction(Action.PAUSE);
  public var _reset = new FunkinAction(Action.RESET);
  #if FEATURE_SCREENSHOTS
  public var _window_screenshot = new FunkinAction(Action.WINDOW_SCREENSHOT);
  #end
  public var _window_fullscreen = new FunkinAction(Action.WINDOW_FULLSCREEN);
  public var _freeplay_favorite = new FunkinAction(Action.FREEPLAY_FAVORITE);
  public var _freeplay_left = new FunkinAction(Action.FREEPLAY_LEFT);
  public var _freeplay_right = new FunkinAction(Action.FREEPLAY_RIGHT);
  public var _freeplay_char_select = new FunkinAction(Action.FREEPLAY_CHAR_SELECT);
  public var _cutscene_advance = new FunkinAction(Action.CUTSCENE_ADVANCE);
  public var _debug_menu = new FunkinAction(Action.DEBUG_MENU);
  #if FEATURE_CHART_EDITOR
  public var _debug_chart = new FunkinAction(Action.DEBUG_CHART);
  #end
  #if FEATURE_STAGE_EDITOR
  public var _debug_stage = new FunkinAction(Action.DEBUG_STAGE);
  #end
  public var _volume_up = new FunkinAction(Action.VOLUME_UP);
  public var _volume_down = new FunkinAction(Action.VOLUME_DOWN);
  public var _volume_mute = new FunkinAction(Action.VOLUME_MUTE);

  public var byName:Map<String, FunkinAction> = new Map<String, FunkinAction>();
  ...
  public function replaceKey(action:FlxActionDigital, toAdd:FlxKey, toRemove:FlxKey, state:FlxInputState)
  {
  ...
  public function replaceButton(action:FlxActionDigital, deviceID:Int, toAdd:FlxGamepadInputID, toRemove:FlxGamepadInputID, state:FlxInputState)
  {
    if (action.inputs.length == 0)
    {
  ...
  public function mergeKeyboardScheme(scheme:KeyboardScheme):Void
  {
    if (scheme != None)
    {
  ...
  public function getDefaultGamepadBinds(control:Control):Array<FlxGamepadInputID>
  {
    switch (control)
    {
      case Control.ACCEPT:
...
class FunkinAction extends FlxActionDigital
{
  ...
  public var cache:Map<String, {timestamp:Int, value:Bool}> = [];
...
{
  public var touchMap:Map<Int, Swipes> = new Map();

  public var vibrationSteps:Int = 5;
  public var curStep:Int = 5;
  public var activateLength:Float = 90;
  public var hapticPressure:Int = 100;
  ...
  public function properTouch(swipe:Swipes):Bool
  {
    curStep = 1;
...
enum abstract Action(String) to String from String
{
  ...
  public var NOTE_UP_P = "note_up-press";
  public var NOTE_LEFT_P = "note_left-press";
  public var NOTE_RIGHT_P = "note_right-press";
  public var NOTE_DOWN_P = "note_down-press";
  public var NOTE_UP_R = "note_up-release";
  public var NOTE_LEFT_R = "note_left-release";
  public var NOTE_RIGHT_R = "note_right-release";
  public var NOTE_DOWN_R = "note_down-release";
  // UI
  public var UI_UP = "ui_up";
  public var UI_LEFT = "ui_left";
  public var UI_RIGHT = "ui_right";
  public var UI_DOWN = "ui_down";
  public var UI_UP_P = "ui_up-press";
  public var UI_LEFT_P = "ui_left-press";
  public var UI_RIGHT_P = "ui_right-press";
  public var UI_DOWN_P = "ui_down-press";
  public var UI_UP_R = "ui_up-release";
  public var UI_LEFT_R = "ui_left-release";
  public var UI_RIGHT_R = "ui_right-release";
  public var UI_DOWN_R = "ui_down-release";
  ...
  #if FEATURE_SCREENSHOTS
  public var WINDOW_SCREENSHOT = "window_screenshot";
  #end
  // CUTSCENE
  ...
  // DEBUG
  public var DEBUG_MENU = "debug_menu";
  #if FEATURE_CHART_EDITOR
  public var DEBUG_CHART = "debug_chart";
  #end
  #if FEATURE_STAGE_EDITOR
  public var DEBUG_STAGE = "debug_stage";
  #end
}
