...
class PreciseInputManager extends FlxKeyManager<FlxKey, PreciseInputList>
{
  ...
  public static function get_instance():PreciseInputManager
  {
   ...
   */
  public var _keyList:Array<FlxKey>;

  /**
   * The direction that a given key is bound to.
   */
  public var _keyListDir:Map<FlxKey, NoteDirection>;

  /**
   * A FlxGamepadID->Array<FlxGamepadInputID>, with FlxGamepadInputID being the counterpart to FlxKey.
   */
  public var _buttonList:Map<Int, Array<FlxGamepadInputID>>;

  public var _buttonListArray:Array<FlxInput<FlxGamepadInputID>>;

  public var _buttonListMap:Map<Int, Map<FlxGamepadInputID, FlxInput<FlxGamepadInputID>>>;

  /**
   * A FlxGamepadID->FlxGamepadInputID->NoteDirection, with FlxGamepadInputID being the counterpart to FlxKey.
   */
  public var _buttonListDir:Map<Int, Map<FlxGamepadInputID, NoteDirection>>;

  /**
   * The timestamp at which a given note direction was last pressed.
   */
  public var _dirPressTimestamps:Map<NoteDirection, Int64>;

  /**
   * The timestamp at which a given note direction was last released.
   */
  public var _dirReleaseTimestamps:Map<NoteDirection, Int64>;

  public var _deviceBinds:Map<FlxGamepad,
    {
  ...
  public static function getPreventDefaultKeys():Array<FlxKey>
  {
  ...
  public function getButton(gamepad:FlxGamepad, button:FlxGamepadInputID):FlxInput<FlxGamepadInputID>
  {
    return _buttonListMap.get(gamepad.id).get(button);
  }

  public function updateButtonStates(gamepad:FlxGamepad, button:FlxGamepadInputID, down:Bool):Void
  {
  ...
  public function handleKeyDown(keyCode:KeyCode, _:KeyModifier, timestamp:Int64):Void
  {
  ...
  public function handleKeyUp(keyCode:KeyCode, _:KeyModifier, timestamp:Int64):Void
  {
    var key:FlxKey = convertKeyCode(keyCode);
    if (_keyList.indexOf(key) == -1) return;
  ...
  public function handleButtonDown(gamepad:FlxGamepad, button:LimeGamepadButton, timestamp:Int64):Void
  {
  ...
  public function handleButtonUp(gamepad:FlxGamepad, button:LimeGamepadButton, timestamp:Int64):Void
  {
    var buttonId:FlxGamepadInputID = FlxGamepadUtil.getInputID(gamepad, button);
  ...
  public static function convertKeyCode(input:KeyCode):FlxKey
  {
    @:privateAccess
    {
...
{
  public var _preciseInputManager:PreciseInputManager;
  ...
  public static function getKeysForDir(noteDir:NoteDirection):Array<FlxKey>
  {
    return PreciseInputManager.getKeysForDirection(PlayerSettings.player1.controls, noteDir);
  }

  public function isKeyValid(key:FlxKey):Bool
  {
    @:privateAccess
    {
  ...
  public function get_NOTE_LEFT():Bool
    return checkDir(NoteDirection.LEFT);

  public var NOTE_DOWN(get, never):Bool;

  public function get_NOTE_DOWN():Bool
    return checkDir(NoteDirection.DOWN);

  public var NOTE_UP(get, never):Bool;

  public function get_NOTE_UP():Bool
    return checkDir(NoteDirection.UP);

  public var NOTE_RIGHT(get, never):Bool;

  public function get_NOTE_RIGHT():Bool
