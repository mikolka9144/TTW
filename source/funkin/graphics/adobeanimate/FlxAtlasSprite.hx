...
class FlxAtlasSprite extends FlxAnimate
{
  ...
  public var _completeAnim:Bool = false;

  public var fr:FlxKeyFrame = null;
  ...
  public function addFrameCallback(label:String, callback:Void->Void):Void
  {
    var frameLabel = this.anim.getFrameLabel(label);
    frameLabel.add(callback);
  }

  public function goToFrameLabel(label:String):Void
  {
    this.anim.goToFrameLabel(label);
  }

  public function getFrameLabelNames(?layer:haxe.extern.EitherType<Int, String> = null)
  {
  ...
  public function getNextFrameLabel(label:String):String
  {
  ...
  public function _onAnimationFrame(frame:Int):Void
  {
  ...
  public function _onAnimationComplete():Void
  {
    if (currentAnimation != null)
    {
  ...
  public var prevFrames:Map<Int, FlxFrame> = [];
