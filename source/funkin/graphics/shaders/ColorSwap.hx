...
class ColorSwap
{
  ...
  public function set_colorToReplace(color:FlxColor):FlxColor
  {
  ...
  public function set_hasOutline(lol:Bool):Bool
  {
    shader.awesomeOutline.value = [lol];
    return lol;
  }

  public function set_daTime(daTime:Float):Float
  {
    return daTime;
  }

  public function set_newColor(color:FlxColor):FlxColor
  {
    newColor = color;
