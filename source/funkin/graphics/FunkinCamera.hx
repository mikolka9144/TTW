...
class FunkinCamera extends FlxCamera
{
  ...
  public var filtersApplied:Bool = false;
  public var bgItemCount:Int = 0;
  ...
  public function squashTo(bitmap:BitmapData, applyFilters:Bool, isolate:Bool, clearScreen:Bool = false):Void
  {
  ...
  public function renderSkipping(count:Int):Void
  {
    var item = _headOfDrawStack;
    while (item != null)
    {
  ...
  public function pickTexture(width:Int, height:Int):TextureBase
  {
