...
class Conductor
{
  ...
  public static var _instance:Null<Conductor> = null;
  ...
  public var prevTimestamp:Float = 0;
  ...
  public function get_startingBPM():Float
  {
    if (bpmOverride != null) return bpmOverride;
   ...
   */
  public var bpmOverride:Null<Float> = null;
  ...
  public function get_measureLengthMs():Float
  {
  ...
  public function get_beatLengthMs():Float
  {
  ...
  public function get_stepLengthMs():Float
  {
    return beatLengthMs / timeSignatureNumerator;
  }
  ...
  public function get_timeSignatureNumerator():Int
  {
  ...
  public function get_timeSignatureDenominator():Int
  {
  ...
  public function get_instrumentalOffsetSteps():Float
  {
  ...
  public function get_inputOffset():Int
  {
    return Save?.instance?.options?.inputOffset ?? 0;
  }

  public function set_inputOffset(value:Int):Int
  {
  ...
  public function get_audioVisualOffset():Int
  {
    return Save?.instance?.options?.audioVisualOffset ?? 0;
  }

  public function set_audioVisualOffset(value:Int):Int
  {
  ...
  public function get_combinedOffset():Float
  {
  ...
  public function get_stepsPerMeasure():Int
  {
  ...
  public static function dispatchMeasureHit():Void
  {
    Conductor.measureHit.dispatch();
  }

  public static function dispatchBeatHit():Void
  {
    Conductor.beatHit.dispatch();
  }

  public static function dispatchStepHit():Void
  {
    Conductor.stepHit.dispatch();
  }

  public static function setupSingleton(input:Conductor):Void
  {
  ...
  public static function clearSingleton(input:Conductor):Void
  {
  ...
  public static function get_instance():Conductor
  {
  ...
  public static function set_instance(instance:Conductor):Conductor
  {
