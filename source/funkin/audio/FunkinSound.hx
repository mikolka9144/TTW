...
{
  public static var MAX_VOLUME:Float = 1.0;
  ...
  public static var _onVolumeChanged:Null<FlxTypedSignal<Float->Void>> = null;

  public static function get_onVolumeChanged():FlxTypedSignal<Float->Void>
  {
   ...
   */
  public static var pool(default, null):FlxTypedGroup<FunkinSound> = new FlxTypedGroup<FunkinSound>();
  ...
  public var _waveformData:Null<WaveformData> = null;

  public function get_waveformData():WaveformData
  {
   ...
   */
  public var _shouldPlay:Bool = false;

  /**
   * For debug purposes.
   */
  public var _label:String = "unknown";
  ...
  public static var partialQueue:Array<Promise<Null<FunkinSound>>> = [];
  ...
  public static function construct():FunkinSound
  {
    var sound:FunkinSound = new FunkinSound();
...
typedef FunkinSoundPlayMusicParams =
{
   ...
   * @default `1.0`
   */
  public var ?startingVolume:Float;
   ...
   * @default `true`
   */
  public var ?mapTimeChanges:Bool;

  /**
   * Which Paths function to use to load a song
   * @default `MUSIC`
   */
  public var ?pathsFunction:PathsFunction;

  public var ?partialParams:PartialSoundParams;
