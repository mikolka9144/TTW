...
class WaveformData
{
  public static var DEFAULT_VERSION:Int = 2;
  ...
  @:jignored
  public var channelData:Null<Array<WaveformDataChannel>> = null;
  ...
  public function buildChannelData():Array<WaveformDataChannel>
  {
    channelData = [];
    for (i in 0...channels)
    {
   ...
   */
  @:jignored
  public var _maxSampleValue:Int = 0;
...
{
  public var parent:WaveformData;
