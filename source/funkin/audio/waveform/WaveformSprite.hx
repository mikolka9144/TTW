...
{
  public static var DEFAULT_COLOR:FlxColor = FlxColor.WHITE;
  public static var DEFAULT_DURATION:Float = 5.0;
  public static var DEFAULT_ORIENTATION:WaveformOrientation = HORIZONTAL;
  public static var DEFAULT_X:Float = 0.0;
  public static var DEFAULT_Y:Float = 0.0;
  public static var DEFAULT_WIDTH:Float = 100.0;
  public static var DEFAULT_HEIGHT:Float = 100.0;
   ...
   */
  public var isWaveformDirty:Bool = true;
  ...
  public function set_waveformData(value:Null<WaveformData>):Null<WaveformData>
  {
  ...
  public function set_waveformColor(value:FlxColor):FlxColor
  {
  ...
  public function set_orientation(value:WaveformOrientation):WaveformOrientation
  {
  ...
  public function buildClippedVertex(x:Int, y:Int, topLeftVertexIndex:Int, topRightVertexIndex:Int, bottomLeftVertexIndex:Int, bottomRightVertexIndex:Int):Int
  {
