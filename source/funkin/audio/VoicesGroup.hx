...
{
  public var playerVoices:FlxTypedGroup<FunkinSound>;
  public var opponentVoices:FlxTypedGroup<FunkinSound>;
  ...
  public function set_playerVolume(volume:Float):Float
  {
  ...
  public function set_playerVoicesOffset(offset:Float):Float
  {
    playerVoices.forEachAlive(function(voice:FunkinSound) {
      voice.time += playerVoicesOffset;
      voice.time -= offset;
  ...
  public function set_opponentVoicesOffset(offset:Float):Float
  {
    opponentVoices.forEachAlive(function(voice:FunkinSound) {
      voice.time += opponentVoicesOffset;
      voice.time -= offset;
  ...
  public function set_opponentVolume(volume:Float):Float
  {
    opponentVoices.forEachAlive(function(voice:FunkinSound) {
      voice.volume = volume;
    });
