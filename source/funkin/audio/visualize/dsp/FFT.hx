...
class FFT
{
  ...
  **/
  ...
  public static function do_fft(input:Array<Complex>, inverse:Bool):Array<Complex>
  {
  ...
  public static function ditfft2(time:Array<Complex>, t:Int, freq:Array<Complex>, f:Int, n:Int, step:Int, inverse:Bool):Void
  {
    if (n == 1)
    {
      freq[f] = time[t].copy();
  ...
  public static function dft(ts:Array<Complex>, ?inverse:Bool):Array<Complex>
  {
