...
class CLIUtil
{
  ...
  public static function interpretArgs(args:Array<String>):CLIParams
  {
  ...
  public static function buildDefaultParams():CLIParams
  {
    return {
      args: [],
   ...
   */
  public static function cleanArgs(args:Array<String>):Array<String>
  {
...
typedef CLIParams =
{
  ...
  public var chart:CLIChartParams;
}

typedef CLIChartParams =
{
  public var shouldLoadChart:Bool;
