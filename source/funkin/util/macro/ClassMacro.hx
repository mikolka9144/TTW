...
class ClassMacro
{
  ...
  public static function doesClassMatchRequest(classType:ClassType, request:String):Bool
  {
  ...
  public static var onGenerateCallbackRegistered:Bool = false;

  public static var classListsRaw:Map<String, Array<String>> = [];
  public static var classListsToGenerate:Array<String> = [];
  #end
}
