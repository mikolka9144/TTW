...
class ScreenshotPlugin extends FlxBasic
{
  ...
  public var _hotkeys:Array<FlxKey>;

  public var _region:Null<Rectangle>;

  public var _shouldHideMouse:Bool;

  public var _flashColor:Null<FlxColor>;

  public var _fancyPreview:Bool;
   ...
   */
  public function showCaptureFeedback():Void
  {
  ...
  public static var PREVIEW_INITIAL_DELAY = 0.25; // How long before the preview starts fading in.
  public static var PREVIEW_FADE_IN_DURATION = 0.3; // How long the preview takes to fade in.
  public static var PREVIEW_FADE_OUT_DELAY = 1.25; // How long the preview stays on screen.
  public static var PREVIEW_FADE_OUT_DURATION = 0.3; // How long the preview takes to fade out.

  public function showFancyPreview(bitmap:Bitmap):Void
  {
    // ermmm stealing this??
    var wasMouseHidden = false;
  ...
  public function openScreenshotsFolder(e:MouseEvent):Void
  {
  ...
  public static function makeScreenshotPath():Void
  {
   ...
   */
  public static function encodePNG(bitmap:Bitmap):ByteArray
  {
