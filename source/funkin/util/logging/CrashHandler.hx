...
class CrashHandler
{
   ...
   */
  public static function onUncaughtError(error:UncaughtErrorEvent):Void
  {
    try
    {
  ...
  public static function onCriticalError(message:String):Void
  {
    try
    {
  ...
  public static function displayError(error:UncaughtErrorEvent):Void
  {
  ...
  #if sys
  public static function logError(error:UncaughtErrorEvent):Void
  {
  ...
  public static function generateErrorMessage(error:UncaughtErrorEvent):String
  {
