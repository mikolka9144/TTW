...
class SaveDataMigrator
{
  ...
  public static function migrateLegacyScores(result:Save, inputSaveData:RawSaveData_v1_0_0):Void
  {
  ...
  public static function migrateLegacyLevelScore(result:Save, inputSaveData:RawSaveData_v1_0_0, levelId:String):Void
  {
  ...
  public static function migrateLegacySongScore(result:Save, inputSaveData:RawSaveData_v1_0_0, songIds:Array<String>):Void
  {
    var scoreDataEasy:SaveScoreData =
      {
        score: 0,
  ...
  public static function migrateLegacyControls(result:Save, inputSaveData:RawSaveData_v1_0_0):Void
  {
  ...
  public static function migrateLegacyPlayerControls(result:Save, playerId:Int, controlsData:SavePlayerControlsData_v1_0_0):Void
  {
